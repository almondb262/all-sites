...
print(fetch_jumia_product(iphoneX))
print(fetch_jumia_product(iphone11_ProMax))
print(fetch_jumia_product(iphone11))
print(fetch_jumia_product(iphone13_ProMax))
print(fetch_jumia_product(iphone12_ProMax))
print(fetch_jumia_product(iphoneXS_Max))
print(fetch_jumia_product(iphone8_plus))
print(fetch_jumia_product(iphoneX))
print(fetch_jumia_product(iphone6_refurbished))
print(fetch_jumia_product(iphone12))